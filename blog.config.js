...
const BLOG = {
  ...
  NOTION_PAGE_ID:
      process.env.NOTION_PAGE_ID || '7da473af27974fc797351e60567be009',
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '80后程序员一枚,欢迎您来阅读我的分享,能认识您是我的荣幸',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Sankyu Tang', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的热爱coding的⚽️足球人', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://sankyu.me', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '博客, 程序员, 前端技术, front-end developer, Notion', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'tangjunaki@126.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || 'https://weibo.com/kenny13', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || 'imsankyu', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/sankyutang', // 你的github个人主页 例如 https://github.com/tangly1024
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'Sankyu Studio', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
      process.env.NEXT_PUBLIC_HOME_BANNER_IMAGE || '/bg_image.jpg', // 首页背景大图, 会被notion中的封面图覆盖，若无封面图则会使用代码中的 /public/bg_image.jpg 文件
  DESCRIPTION:
      process.env.NEXT_PUBLIC_DESCRIPTION || 'Website build in Notion&Next', // 站点描述，被notion中的页面描述覆盖
